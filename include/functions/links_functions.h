...
xbase::XResult<ILink::SPtr> CreateLink(const ILink::OnDataPF&         _on_data_pf,
                                       ...
                                       const xbase::IScheduler::SPtr& _custom_scheduler = {});
...
std::pair<MediaUnitsVec, MediaUnitsVec> SetMediaUnits(IMediaUnitAgent* _props_agent_p,
                                                      MediaUnitsVec&&  _media_props,
                                                      bool             _reset_props);

std::pair<MediaUnitsVec, MediaUnitsVec> SetMediaUnits(IObject*        _media_link_p,
                                                      MediaUnitsVec&& _media_props,
                                                      bool            _reset_props);

MediaUnitsVec GetMediaUnits(IObject*                         _media_link_p,
