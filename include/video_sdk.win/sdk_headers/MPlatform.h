...
#ifndef __MWrapper_FWD_DEFINED__
    #define __MWrapper_FWD_DEFINED__

    #ifdef __cplusplus
typedef class MWrapper MWrapper;
    #else
typedef struct MWrapper MWrapper;
    #endif /* __cplusplus */

#endif /* __MWrapper_FWD_DEFINED__ */
...
EXTERN_C const CLSID CLSID_MWrapper;

    #ifdef __cplusplus

class DECLSPEC_UUID("4985960B-08F5-4C7A-B439-3255A8A8E9E4") MWrapper;
    #endif
